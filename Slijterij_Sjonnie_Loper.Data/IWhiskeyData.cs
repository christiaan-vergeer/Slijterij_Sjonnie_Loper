...
namespace Slijterij_Sjonnie_Loper.Data
{
    public interface IWhiskeyData
    {
        ...
        IEnumerable<Whiskey> GetAllByFind(string searchname, int searchage, string searcharea, int searchper);
    }
    ...
    public class InMemoryWhiskeyData : IWhiskeyData
    {
        ...
        public IEnumerable<Whiskey> GetAllByFind(string SearchName, int SearchAge, string SearchArea, int SearchPercentage)
        {
